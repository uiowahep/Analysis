...
f = R.TFile("/Users/vk/software/Analysis/files/results/test/validate_dimu_mass_PF_110_160_x69p2_8_0_X_MC_run1categories_36814.root")
f.ls()
...
path = "/Users/vk/software/Analysis/files/results/test"
for pp in mapPP2ListOfCats:
    resultFile = R.TFile(path+"/result__%s__80X__Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16_JSON__69mb__Mu24.root" % pp, "RECREATE")
...
for run in mapRun2ListOfCats:
    resultFile = R.TFile(path+"/result__%s__Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16_JSON__Mu24.root" % run, "RECREATE")
